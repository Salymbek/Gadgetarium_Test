...
VALUES (322323, 78000, 1, 8, 256, 1, 2, 'asc', '#000000', '1920x1080', 4.3),
       ...
       (987665, 79000, 1, 0, 0, 6, 1, 'bvcb', '#FF0000', NULL, 3.1),
       (654321, 120000, 1, 0, 0, 7, 1, 'vcvb', '#FF5500', NULL, 4.5),
       (123987, 95000, 1, 0, 0, 8, 1, 'qazx', '#FFA77F', NULL, 3.8),
       (789456, 110000, 1, 0, 0, 9, 1, 'wsxc', '#CD8966', NULL, 4.2),
       (456123, 83000, 1, 0, 0, 10, 1, 'edcv', '#CDAA66', NULL, 4.9),

       (234567, 60000, 1, 6, 128, 11, 1, 'bcvn', '#FFEBBE', NULL, 4.2),
       (789012, 80000, 1, 8, 256, 12, 3, 'tyio', '#FFD37F', NULL, 3.9),
       (345678, 68000, 1, 6, 256, 13, 3, 'qwerty', '#FFAA00', NULL, 4.7),
       (901234, 72000, 1, 8, 128, 14, 5, 'zxcvb', '#FFFF72', NULL, 4.1),
       (567890, 74000, 1, 8, 256, 15, 5, 'asdfg', '#E6E600', NULL, 3.6);
