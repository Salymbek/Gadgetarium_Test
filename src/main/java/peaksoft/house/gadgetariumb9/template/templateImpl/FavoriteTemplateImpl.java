...
public class FavoriteTemplateImpl implements FavoriteTemplate {
  ...
  public List<UserFavoritesResponse> getAllFavoriteByUserId(Long userId) {
    ...
    List<UserFavoritesResponse> userFavoritesResponses = jdbcTemplate.query(sql, (rs, rowNum) -> UserFavoritesResponse
            .builder()
    ...
    for (UserFavoritesResponse s : userFavoritesResponses) {
      s.setBasket(basket.contains(s.getSubProductId()));
    }
    return userFavoritesResponses;
  }
